...
class FoodPredictScheduleLayout extends StatefulWidget {
  FoodPredictScheduleLayout({Key key}) : super(key: key);

  @override
  _FoodPredictScheduleLayoutState createState() =>
      _FoodPredictScheduleLayoutState();
}

class _FoodPredictScheduleLayoutState extends State<FoodPredictScheduleLayout> {
