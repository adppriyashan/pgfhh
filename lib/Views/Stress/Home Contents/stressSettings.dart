...
class StressPredictSettingsLayout extends StatefulWidget {
  StressPredictSettingsLayout({Key key}) : super(key: key);

  @override
  _StressPredictSettingsLayoutState createState() =>
      _StressPredictSettingsLayoutState();
}

class _StressPredictSettingsLayoutState
    extends State<StressPredictSettingsLayout> {
  @override
